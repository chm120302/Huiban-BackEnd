...
//    @JsonFormat(pattern = "yyyy-MM-dd", timezone = "UTC")
    ...
    public ConferenceDetail( String conferenceId, String fullTitle, String ccfRank, String dblpLink, String mainpageLink, String place, Date abstractDeadline, Date paperDeadline, Date startTime, Date endTime, int followNum, Integer attendNum, int sessionNum, String topicDetails, boolean isPostponed) {
