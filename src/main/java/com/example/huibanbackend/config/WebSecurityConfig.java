        ...
        http    .httpBasic(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(
                        request -> request
                                ...
                                .requestMatchers("/api/users/info/{email}").hasAuthority("5")
                                ...
                                .requestMatchers("/api/conferences/recentList").hasAuthority("13")
                                .requestMatchers("/api/conferences/popularList").hasAuthority("14")
                                ...
                                .requestMatchers("/api/journals/popularList").hasAuthority("32")
